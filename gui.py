...
class JohnnyFiveApp(tk.Tk):
    ...
    def send_intro_message(self):
        intro_message = self.chat.send_message("A new conversation has started, briefly introduce yourself as johnny Five and Advanced Nueral Network brought back to life Sean Doherty and then ask who you are speaking to.")
