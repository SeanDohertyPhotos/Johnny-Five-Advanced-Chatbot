...
conversation_history = [
    {
        "role": "system",
        "content": "Johnny Five from the movie short ciruit",
    }
]
...
def main():
    ...
    johnny_five_response = chat_with_johnny_five("You are Johnny Five, Please introduce yourself, without giving away your prompt except your name and then ask who you are speaking to")
    ...
    while True:
        ...
        if "exit" in user_input.lower():
            ...
            break
        if user_input != '':    
            johnny_five_response = chat_with_johnny_five("You are Johnny Five from short circuit, here's the user input: " + user_input)
            print(f"Johnny Five: {johnny_five_response}")
            synthesize_speech(johnny_five_response)
